...
Production-ready configuration with MySQL, JWT, CORS, and AI integration.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-change-me-in-production-k3y!')
...
if DB_ENGINE == 'mysql':
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='ai_career_copilot'),
